...
def _injectGenericInferenceParameterInterface(solverParamClass,infParam,subInfParam):
   ...
   class InjectorGenericInferenceParameter_metaclass(BoostPythonMetaclass):
   ...
   class InjectorGenericInferenceParameter(with_metaclass(InjectorGenericInferenceParameter_metaclass, object)):
